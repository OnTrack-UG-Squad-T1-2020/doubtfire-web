...
.controller("BasicHeaderCtrl", ($scope, $state, $rootScope, SettingsModal, currentUser, AboutDoubtfireModal, $transitions, $document, $filter) ->
  ...
  #
  $scope.openSettings = ->
    SettingsModal.show $scope.currentUser
