...
import { OngoingTutorialChipComponent } from './common/header/ongoing-tutorial-chip/ongoing-tutorial-chip.component';
...
DoubtfireAngularJSModule.directive('ongoingTutorialChip',
  downgradeComponent({ component: OngoingTutorialChipComponent }));
