...
import { SettingsModalService} from './common/modals/settings-modal/settings-modal.service';
...
DoubtfireAngularJSModule.factory('SettingsModal',
  downgradeInjectable(SettingsModalService));
